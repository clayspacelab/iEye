function [ii_data,ii_cfg] = ii_reach_selectbyvalue(ii_data,ii_cfg, c, cond, cval)
...
elseif isnumeric(c)
    ...
    if numel(c)~=numel(ii_cfg.reach_sel)
...
%ii_hideselections;
[ii_data,ii_cfg] = ii_reach_selectempty(ii_data,ii_cfg); % NOTE: do we need this???


sel = ii_cfg.reach_sel; %this is the velocity derived 
