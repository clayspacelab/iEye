function [ii_data,ii_cfg] = ii_import_edf_mgrs(edf_file,ifg_file,data_file, varargin)
...
%here, get rid of wrongly assigned tarX,tarY outputs to XDAT during
...
%additions for reach files 
ii_cfg.reach_velocity = []; %added by geh 6/25/19
ii_cfg.reach_history = []; 
ii_cfg.reaches =[];
ii_cfg.reach_sel = x*0; %reach selections 
ii_cfg.reach_cursel =[];
ii_cfg.reach_drift.amt = [];
ii_cfg.reach_file = []; 
